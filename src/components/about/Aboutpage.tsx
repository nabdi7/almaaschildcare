    ...
    <section>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
          ...
          located in the heart of Seattle, WA. We provide a safe, nurturing
          environment for children to learn, grow, and thrive. Our program is
          designed to meet the unique needs of each child, with a focus on
          social, emotional, physical, and cognitive development. We believe
          that every child is a unique individual, and we are committed to
          helping them reach their full potential. Our goal is to create a warm
          and welcoming environment where children feel safe, loved, and
          supported
        </p>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="bg-gray-800 text-white rounded-lg p-8 md:w-1/2 flex flex-col justify-center items-center text-center">
            ...
            <p className="max-w-md">
              ...
              possible start in life, and we are dedicated to helping them reach
          ...
          <div className="md:w-1/2">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                ...
                Our programs include early literacy, math, science, art, music,
                and more. We also provide homework help and tutoring for
                school-age children.
              </p>
            </div>
